    ...
    <?php echo form_open("siswa/ubah/".$siswa->nis); ?>
     <div align="center"> 
      <table class="table table-stiped"  style="width: 500px; height: 400px">
        <tr>
          <td>NIS</td>
          <td scope="col"><input type="text" name="input_nis" value="<?php echo set_value('input_nis', $siswa->nis); ?>"
        ...
        <tr>
          <td>Keahlian</td>
          <td scope="col"><input type="text" name="input_keahlian" value="<?php echo set_value('input_keahlian', $siswa->keahlian); ?>" style="width: 230px;"></td>
        </tr>
        <tr>
          <td>Alamat</td>
